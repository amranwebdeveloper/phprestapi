...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 18, 2022 at 09:39 AM
...
CREATE TABLE IF NOT EXISTS `annotation` (
  ...
  `objectid` varchar(255) DEFAULT NULL COMMENT 'Object ID,Guid',
  `ownerid` int(11) NOT NULL COMMENT 'Owner,Lookup - User',
  `modifiedby` int(11) DEFAULT NULL COMMENT 'Modified by,Lookup - User',
  `createdby` int(11) NOT NULL COMMENT 'Created by,Lookup - User',
  `annotationid` varchar(255) DEFAULT NULL COMMENT 'Attachment ID,GUID',
  PRIMARY KEY (`id`)
...
INSERT INTO `annotation` (`id`, `filename`, `notetext`, `subject`, `body`, `objectid`, `ownerid`, `modifiedby`, `createdby`, `annotationid`) VALUES
(1, 'aalu1.jpg', 'ddddd', 'sdgsdgsdsdg', 'ddddddddd', '123', 2, NULL, 2, '36');
...
(17, NULL, 10, 1627790378),
(18, NULL, 10, 1627790386),
(19, NULL, 10, 1627798263),
(20, NULL, 2, 1628001751),
(21, NULL, 2, 1628005103),
(22, 'New Memo', 2, 1642353789),
(23, 'New Memo', 2, 1642359018),
(24, 'New Memo', 2, 1642359082),
(25, 'New Memo', 2, 1642359177),
(26, 'New Memo', 2, 1642359293),
(27, 'New Memo', 2, 1642359381),
(28, 'New Memo', 2, 1642359429),
(29, 'New Memo', 2, 1642359604),
(30, 'New Memo', 2, 1642359622),
(31, 'New Memo', 2, 1642360292),
(32, 'New Memo', 2, 1642360327),
(33, 'New Memo', 2, 1642360853),
(34, 'New Memo', 2, 1642360969),
(35, 'New Memo', 2, 1642361034),
(36, 'New Memo', 2, 1642361054);
